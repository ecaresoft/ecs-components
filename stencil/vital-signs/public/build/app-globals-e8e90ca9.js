import { B as BUILD, C as CSS, p as plt, w as win, a as promiseResolve, c as consoleDevInfo, H, d as doc, N as NAMESPACE } from './index-dda38639.js';
...
const patchEsm = () => {
    ...
    if (BUILD.cssVarShim && !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_ste(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-5ce2b5c4.js').then(() => {
...
const patchBrowser = () => {
    ...
    if (!BUILD.safari10 && importMeta !== '') {
        ...
        if (BUILD.dynamicImportShim && !win.customElements) {
            ...
            // @ts-ignore
            return __sc_import_ste(/* webpackChunkName: "polyfills-dom" */ './dom-91ed8d21.js').then(() => opts);
        }
    }
